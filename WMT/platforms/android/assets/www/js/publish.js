...
(function ($) {
        ...
        WMT.jqXHR(ajaxcallobj, function (response) {
            ...
            if (response.StorePicture.length > 0) {
                ...
                for (var i = 0; i < response.StorePicture.length; i++) {
                    ...
                    + '<div class="ui-btn ui-input-btn ui-btn-b ui-corner-all ui-shadow ui-btn-inline"><span class="pub_mod">修改</span><input type="button" name="Help" value="Edit" class="btn-download btnEdit" data-type="storepicture" data-id="' + response.StorePicture[i].PID + '" data-inline="true" data-theme="b"></div></div></div></div></div>';
                }
            }
            if (response.ProductDiscount.length > 0) {
                ...
                for (var i = 0; i < response.ProductDiscount.length; i++) {
                    ...
                    + '<div class="price-yaun"><div style="text-align:left"><p>价格: <span id="spnProductPrice" class="clsShow">' + response.ProductDiscount[i].price + '</span>'
                    ...
                    + '<div style="text-align:left"><p>折扣: <span id="spnDiscount" class="clsShow">' + response.ProductDiscount[i].discount + '</span>'
                    ...
                    + '<div class="ui-btn ui-input-btn ui-btn-b ui-corner-all ui-shadow ui-btn-inline"><span class="pub_mod">修改</span><input type="button" name="Help" value="Edit" class="btn-download btnEdit" data-type="productdiscount" data-id="' + response.ProductDiscount[i].PID + '" data-inline="true" data-theme="b"></div></div></div></div></div>';
                }
            }
            if (response.ProductPromotion.length > 0) {
                ...
                for (var i = 0; i < response.ProductPromotion.length; i++) {
                    ...
                    + '<div class="ui-btn ui-input-btn ui-btn-b ui-corner-all ui-shadow ui-btn-inline"><span class="pub_mod">修改</span><input type="button" name="Help" value="Edit" class="btn-download btnEdit" data-type="productpromotion" data-id="' + response.ProductPromotion[i].PID + '" data-inline="true" data-theme="b"></div></div></div></div></div>';
                }
            }
            if (response.GiftPoint.length > 0) {
                ...
                for (var i = 0; i < response.GiftPoint.length; i++) {
                    ...
                    + '<div class="price-yaun"><div style="text-align:left"><p>价格: <span id="spnProductPrice" class="clsShow">' + response.GiftPoint[i].price + '</span>'
                    ...
                    + '<div style="text-align:left"><p>礼品点: <span id="spnGifPoint" class="clsShow">' + response.GiftPoint[i].giftPoint + '</span>'
                    ...
                    + '<div class="ui-btn ui-input-btn ui-btn-b ui-corner-all ui-shadow ui-btn-inline"><span class="pub_mod">修改</span><input type="button" name="Help" value="Edit" class="btn-download btnEdit" data-type="giftpoint" data-id="' + response.GiftPoint[i].PID + '" data-inline="true" data-theme="b"></div></div></div></div></div>';
                }
            }
            if (html != '') {
    ...
    var switchToSpan = function (obj) {
        ...
        $('div#dvPublishedProduct').find('div.ui-btn-inline').find('.pub_mod').html('修改');
        $('div#dvPublishedProduct').find('div.ui-btn-inline').find('.pub_del').html('删除');
    ...
    var switchToInputs = function (obj) {
        ...
        obj.parent('div.ui-btn-inline').find('.pub_mod').html('保存');
        obj.parent('div.ui-btn-inline').parent().find('.pub_del').html('取消');
    ...
    var updatePublishedInformation = function (type, info, price, discount, giftPoint, PID, $this) {
        ...
        WMT.jqXHR(ajaxcallobj, function (response) {
            if (response.success > 0) {
                ...
                switchToSpan($this);
                $.dynamicSuccess_popup('<p>产品细节更新成功地.</p> <a href="#" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b clsok" data-theme="b" data-rel="back">确定</a>');
            }
            else {
                $.dynamic_popup('<p>错误.</p> <a href="#" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b clsok" data-theme="b" data-rel="back">确定</a>');
            }
        });
