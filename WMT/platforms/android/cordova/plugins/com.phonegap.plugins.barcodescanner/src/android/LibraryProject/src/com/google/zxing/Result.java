...
public final class Result {
  ...
  private final BarcodeFormat2 format;
  ...
  /**
   * @return {@link BarcodeFormat2} representing the format of the barcode that was decoded
   */
  public BarcodeFormat2 getBarcodeFormat() {
    return format;
  }
