            ...
            if (response.ProductDiscount.length > 0) {
                ...
                for (var i = 0; i < response.ProductDiscount.length; i++) {
                    html += '<div class="points-main"><p></p><div class="uploder"><div class="view-published">'
                         ...
                         + '<p class="price-yaun-left price-yaun-status">Status:   <select data-role="flipswitch"><option value="Active">Active</option><option value="Finished">Finished</option></select></p>'
