...
(function($){
    ...
    function dynamicPopup(){
        ...
        this.createPopupElements = function(){
            ...
            if( !$popup.length ){
                ...
                $popupMain = $('<div ><div data-role="header" style="display:none;" data-theme="a" class="ui-header ui-bar-a" style="top: -10px;border-radius: 5px;"> <h1> 警告</h1> </div></div>').attr({
                                                    'id': settings.popupId,
                                                    'data-role': 'popup',
    ...
    function dynamicPopupSuccess() {
        ...
        this.init = function (options) {
            ...
            this.createSuccessPopupElements();
            this.populateSuccessPopupContent();
            this.putSuccessPopupInDOM();
        ...
        // Create the popup objects without the actual contents.
        // If the popup container exists return it's objects.
        this.createSuccessPopupElements = function () {
        ...
        // Populate the popup's content.
        this.populateSuccessPopupContent = function () {
        ...
        this.putSuccessPopupInDOM = function () {
        ...
        this.openSuccessPopup = function () {
    ...
    $.dynamicSuccess_popup = function (options) {

        var popup = new dynamicPopupSuccess();
        return popup.init(options);
    }
